      ...
      <div className="container mx-auto p-4">
        <div className="text-center min-h-[60vh] flex flex-col items-center justify-center">
          ...
          >
            ...
            <p className="text-white mb-6">ขออภัย ไม่สามารถโหลดข้อมูลเกมได้</p>
            <Link 
              to="/" 
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div 
          className="relative h-[400px] rounded-lg overflow-hidden border-2 border-gray-700 mb-6"
          style={{ boxShadow: '6px 6px 0px 0px rgba(43,43,43,0.3)' }}
        >
          <img 
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6">
            ...
            <div className="flex flex-wrap gap-3 items-center">
              {game.metacritic && (
                <div className="px-3 py-1 bg-green-400 text-white font-bold border-2 border-white rounded flex items-center gap-2">
                  <Gamepad2 className="w-5 h-5" />
                  <span>Metacritic: {game.metacritic}</span>
                </div>
              )}
              <div className="px-3 py-1 bg-orange-400 text-white font-bold border-2 border-white rounded flex items-center gap-2">
                <Star className="w-5 h-5 fill-white" />
                <span>Rating: {game.rating.toFixed(1)} / 5</span>
              </div>
              {game.released && (
                <div className="px-3 py-1 bg-blue-400 text-white font-bold border-2 border-white rounded flex items-center gap-2">
